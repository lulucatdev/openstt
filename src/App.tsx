...
const translations = {
  en: {
    ...
    scribeV2Flash: "Scribe v2 Flash",
    scribeV2FlashDesc: "Fast transcription with lower latency",
...
function App() {
  ...
  const cloudModels = [
    ...
    {
      id: "elevenlabs:scribe_v2_flash",
      name: t("scribeV2Flash"),
      size: "Cloud",
      description: t("scribeV2FlashDesc"),
      engine: "elevenlabs",
      downloaded: true,
      downloadUrl: "",
      localPath: null,
